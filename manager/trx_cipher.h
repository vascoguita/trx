...
TEE_Result trx_cipher_encrypt(trx_vk *vk, TEE_UUID *uuid, void *src, size_t src_size,
                              unsigned long int new_version, void *id, size_t id_size, void *dst, size_t *dst_size);
TEE_Result trx_cipher_decrypt(trx_vk *vk, TEE_UUID *uuid, void *src, size_t src_size, unsigned long int *last_version,
                                void *id, size_t id_size, void *dst, size_t *dst_size);
