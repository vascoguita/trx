...
TEE_Result trx_share(trx_handle handle, const unsigned char *R, size_t R_size, const char *mount_point,
                     size_t mount_point_size, const char *label, size_t label_size, void *dst, size_t *dst_size);
TEE_Result trx_mount(trx_handle handle, const unsigned char *S, size_t S_size, const char *ree_dirname,
                     size_t ree_dirname_size, const char *mount_point, size_t mount_point_size, char *src, size_t src_size);
